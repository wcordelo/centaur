module SandboxEntitlements
  module Jwt
    ...
    # The token is scoped to sandbox endpoints. Each authenticated endpoint
    # re-validates the proxy -> principal binding against the database, so
    # reassignment revokes access immediately regardless of exp. Rotation is
